...
const CubesCanvas = () => {
  ...
  return (
    <Canvas>
      ...
      <pointLight position={[0.8, 1.8, 1]} intensity={2} color="#E7822C" />
      {/* light sphere left bottom */}
      <pointLight position={[-1, -1, 1]} intensity={1.5} color="#E7822C" />
      {/* box center */}
      <animated.mesh
        scale={[1.5, 1.5, 1.5]}
        position={position2}
